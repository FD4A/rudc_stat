...
# # Krasnodar data
# filenames = glob('./RawData/Krasnodar_data/Krasnodar_2024_04_29.txt')
# for filename in filenames:
...
# # Spb data
# filenames = glob('RawData/Spb_data/2024_05_09_Spb_Regular.txt')
# for filename in filenames:
#     parser = ParseRawTxtCommon(ParseRawTxtCommon.parser_aetherhub, legendary_base)
#     tournament = parser.get_tournament_from_txt(filename)
#     print(tournament)
...
# # Volgograd data
# filenames = glob('RawData/Volgograd_data/2024_05_04_Volgograd_Open_Top.txt')
# for filename in filenames:
#     parser = ParseRawTxtCommon(ParseRawTxtCommon.parser_aetherhub, legendary_base)
#     tournament = parser.get_tournament_from_txt(filename)
#     print(tournament)
